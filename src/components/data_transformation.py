...
class DataTransformation:
    ...
    def get_data_transformer_object(self):
        try:
            ...
            logging.info("Numerical features standardization")
            ...
            logging.info("Categorical features one hot encoding")
            ...
            logging.info(f"categorical_columns:{numerical_columns }")
    ...
    def initiate_data_tranfromation(self,train_path,test_path):
        try:
            ...
            logging.info("Finished reading of test and train data")
            ...
            logging.info("Applying preprocess_obj on train_df and test_df")
